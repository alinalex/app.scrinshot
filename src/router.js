...
const routes = [
  ...
  },
  {
    ...
    Component: lazy(() => import('pages/account/subscription')),
    exact: true,
  },
  {
    path: '/account/activate/:id',
    Component: lazy(() => import('pages/account/activate')),
    exact: true,
  },
  ...
  // Screenshots
  {
    ...
    Component: lazy(() => import('pages/screenshot/dashboard')),
    exact: true,
  },
  {
    path: '/screenshots/add',
    Component: lazy(() => import('pages/screenshot/add')),
    exact: true,
  },
  {
    path: '/screenshots/my-screenshots',
    Component: lazy(() => import('pages/screenshot/myScreenshots')),
    exact: true,
  },
  {
    path: '/screenshots/:id',
    Component: lazy(() => import('pages/screenshot/getScreenshot')),
    exact: true,
  },
  {
    path: '/screenshots/:id/edit',
    Component: lazy(() => import('pages/screenshot/editScreenshot')),
    exact: true,
  },
  ...
  },
  {
    ...
    Component: lazy(() => import('pages/auth/reset-forgot-password')),
    exact: true,
  },
  {
    path: '/auth/register',
              ...
              <SwitchTransition>
                ...
                >
                  <Switch location={location}>
                    <Route exact path="/" render={() => <Redirect to="/screenshots/dashboard" />} />
