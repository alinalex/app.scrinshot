...
const MenuLeft = ({
  ...
  const onCollapse = (value, type) => {
    ...
    changeSetting({ payload: { setting: 'isMenuCollapsed', value: !isMenuCollapsed } })
    // dispatch({
  ...
  const generateLogo = () => {
    if (menuColor === 'light') {
      // light theme
      if (isMobileView || !isMenuCollapsed) {
        return <img src="/resources/images/logo.svg" className="mr-2" alt="Scrinshot" />
      }

      return <img src="/resources/images/logoCollapsed.svg" className="mr-2" alt="Scrinshot" />
    }

    // dark theme
    if (isMobileView || !isMenuCollapsed) {
      return <img src="/resources/images/logoWhite.svg" className="mr-2" alt="Scrinshot" />
    }
    return <img src="/resources/images/logoWhiteCollapsed.svg" className="mr-2" alt="Scrinshot" />
  }
      ...
      >
        <div className={style.logoContainer}>
          <div className={style.logo}>
            <Link to="/screenshots/dashboard">
              {/* {isMenuCollapsed ? (
                <img src="/resources/images/logoCollapsed.svg" className="mr-2" alt="Scrinshot" />
              ) : menuColor === 'light' ? (
                <img src="/resources/images/logo.svg" className="mr-2" alt="Scrinshot" />
              ) : (
                <img src="/resources/images/logoWhite.svg" className="mr-2" alt="Scrinshot" />
              )} */}
              {generateLogo()}
            </Link>
          </div>
...
export default withRouter(connect(mapStateToProps, { changeSetting })(MenuLeft))
