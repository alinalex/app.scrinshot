...
const Menu = ({ isMobileMenuOpen, isMobileView, menuLayoutType, leftMenuWidth, changeSetting }) => {
  useEffect(() => {
  ...
  const toggleMobileMenu = () => {
    changeSetting({ payload: { setting: 'isMobileMenuOpen', value: !isMobileMenuOpen } })
    // dispatch({
...
export default connect(mapStateToProps, { changeSetting })(Menu)
